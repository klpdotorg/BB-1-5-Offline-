...
Game.selectgrade4MicroConceptScreen.prototype={
	...
	create:function(game){	
		...
		nativeApp.screenViewStringPass("Practice_topic_selection_screen","grade4MicroConceptScreen");
		...
		else if(grade4ShapesSenseSelected)
		{
		...
		else if(grade4DataHandlingSelected)
		{
			this.state.start('grade4DataHandling',true,false);
		}
		else
		{
	...
	microConceptTopics:function(game,x,y,lang,name,key,arrIndex)
	{
		...
		this.gradeTreeTxt[arrIndex].fontSize = 21;
