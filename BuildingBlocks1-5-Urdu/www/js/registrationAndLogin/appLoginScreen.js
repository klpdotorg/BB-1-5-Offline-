...
Game.appLoginScreen.prototype = {
	...
	startGame: function () {
		...
		var titleTxt = _this.add.text(_this.world.centerX, 45, "Building Blocks 1-5 URD");//-140
		...
		if (result.rows.length > 0) {
			...
			if (_this.userArray.length < 6) {
				...
				_this.regandstsrtBtn.events.onInputDown.add(function () {
					...
					_this.state.start('registrationPicSelectionScreen', true, false, window.languageSelected, _this.userArray);
